...
//     id: 4,
//     name: "Creative",
//     description: "Stylish layout for designers & developers.",
//   },
// ];
...
//                   <button className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-700 py-3 transition hover:border-cyan-500 hover:text-cyan-400">
//                     <Eye size={18} />
//                     Preview
//                   </button>

//                   <button className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-cyan-500 py-3 font-medium transition hover:bg-cyan-400">
//                     Use
//                     <ArrowRight size={18} />
//                   </button>
//                 </div>
